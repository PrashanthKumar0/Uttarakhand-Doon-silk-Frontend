...
const SectionHero2: FC<SectionHero2Props> = ({ className = "" }) => {
  ...
  const renderItem = (index: number) => {
    ...
    return (
      <div
        className={`nc-SectionHero2Item nc-SectionHero2Item--animation flex flex-col-reverse lg:flex-col relative overflow-hidden height ${className}`}
        key={index}
      >
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-20 flex justify-center height">
          {DATA.map((_, index) => {
            const isActive = indexActive === index;
            return (
              <div
        ...
        <div className="relative container pb-0 pt-14 sm:pt-20 lg:py-44 height">
          <div
